 ...
 * 
 * Displays real-time upload and download speeds. Subscribes to the centralized
 * SystemMonitorEngine to read and parse rates efficiently from /proc/net/dev.
 * ============================================================================
 */
...
/** Formats bytes per second into human-readable B/s, KB/s, or MB/s. */
...
/** Creates a speed display row (icon + speed label). */
...
/** Creates a network speed monitor widget node. */
